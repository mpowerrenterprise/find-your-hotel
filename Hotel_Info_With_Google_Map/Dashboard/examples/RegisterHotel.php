      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <p class="navbar-brand" href="#pablo" style="position: relative;left: 420px;">Register Hotels</p>
          </div>
          ...
          ?>
            ...
            <div class="card stacked-form" style="position: relative;left: 190px;">
              ...
              <div class="card-body"> 
                ...
                <form method="post" action="../../PHP/insertHotel.php">
                  ...
                  <input type="submit" value="Register" style="text-align: center;position: relative;left: 250px;" class="btn btn-success btn-wd" name="sub">
